...
using UnityEngine;
using UnityEngine.UI;  // Adiciona o namespace UI correto
...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public abstract class ComponentAction<T> : FsmStateAction where T : Component
    {
        ...
        #endif
        protected UnityEngine.UI.Text uiText  // Usa o namespace correto aqui
        {
            get { return cachedComponent as UnityEngine.UI.Text; }
        }

        protected UnityEngine.UI.Image uiImage  // E aqui também
        {
            get { return cachedComponent as UnityEngine.UI.Image; }
        }
        #if UNITY_2017_2_OR_NEWER
